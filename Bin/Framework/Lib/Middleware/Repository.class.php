...
namespace Bin\Framework\Lib\Middleware;


use Bin\Framework\Lib\Database\DBInterface;
use Bin\Framework\Lib\Database\SqlsrvDB;
...
class Repository
{
    ...
    {
        if ($operation != 'DELETE' && empty($what)) return false;
